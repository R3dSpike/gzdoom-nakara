...
class Actor : Thinker native
{
	...
	native color FocusTintColor;
	native double FocusTintAmount;
	native int FocusTintStyle;
	native bool bFocusTintColorSet;
	native color FocusTintOutlineColor;
	native bool bFocusTintOutlineColorSet;
	native double FocusTintOutlineThickness;
	native color VisThruWallColor;
	native bool bVisThruWallColorSet;
	native double VisThruWallAlpha;
	native bool bVisThruWallAlphaSet;
	native double VisThruWallSpriteAlpha;
	native bool bVisThruWallSpriteAlphaSet;
	native double VisThruWallOutlineThickness;
	native double VisThruWallOutlineAlpha;
	native bool bVisThruWallOutlineAlphaSet;
	native double VisThruWallMaxDistance;
	native double VisThruWallFadeDistance;
	native double VisThruWallFadeInTics;
	native double VisThruWallFadeOutTics;
	native uint VisThruWallMask;
	native Sector CurSector;
	native double CeilingZ;
	native double FloorZ;
	native double DropoffZ;
	...
	property VisThruWallMask: VisThruWallMask;
  ...
  // Called in TryMove if the mover ran into another Actor. This isn't called on players
	...
	native static void PrecacheActorClass(class<Actor> cls);
	...
	native void A_SmartChase(statelabel melee = '_a_chase_default', statelabel missile = '_a_chase_default', int flags = 0);
	native bool A_KitsuneSpiritMove(int role = 0, double moveSpeed = 18.0, bool hypnotizeConverge = false);
	native void A_HypnotizeChase(statelabel melee = '_a_chase_default', statelabel missile = '_a_chase_default', int flags = 0);
