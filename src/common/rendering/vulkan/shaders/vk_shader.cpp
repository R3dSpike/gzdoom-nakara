...
static const char *shaderBindings = R"(
	...
	struct StreamData
	{
		...
		vec4 uDetailParms;
		vec4 uNpotEmulation;
		vec4 padding1, padding2, padding3, padding4, padding5;
	};
	...
	#define uFocusHighlight data[uDataIndex].padding1.x
	#define uFocusTintColor data[uDataIndex].padding2
	#define uFocusTintAmount data[uDataIndex].padding2.w
	#define uFocusTintStyle int(data[uDataIndex].padding1.y)
	#define uFocusOutlineColor data[uDataIndex].padding3
	#define uFocusOutlineThickness data[uDataIndex].padding3.w
	#define uNkVisThruWallTint data[uDataIndex].padding4
	#define uNkVisThruWallSpriteAlpha data[uDataIndex].padding1.z
	#define uNkVisThruWallOutlineThickness data[uDataIndex].padding1.w
	#define uNkVisThruWallOutlineAlpha data[uDataIndex].padding5.x
	#define uNkCloakAmount data[uDataIndex].padding5.y
	...
	// [Nakara] Receiver-shader sprite shadow projectors for Vulkan.
	// This mirrors the OpenGL NkSpriteProjectorBuffer declaration, but uses
	// Vulkan descriptor set 1 / binding 5 instead of OpenGL binding 8.
	...
	layout(set = 1, binding = 5, std430) buffer NkSpriteProjectorBuffer
	{
