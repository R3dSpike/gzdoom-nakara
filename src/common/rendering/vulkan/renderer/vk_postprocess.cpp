...
void VkPostprocess::ImageTransitionScene(bool undefinedSrcLayout)
{
	...
	VkImageTransition()
		...
		.AddImage(&buffers->SceneFocusInfo, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL, undefinedSrcLayout)
		.AddImage(&buffers->SceneCloak, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL, undefinedSrcLayout)
