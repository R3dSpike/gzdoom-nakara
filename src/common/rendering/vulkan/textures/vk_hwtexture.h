...
private:
	...
	void CreateTexture(int w, int h, int pixelsize, VkFormat format, const void *pixels, bool mipmap, FTexture *sourceTex = nullptr, int translation = 0, int flags = 0, uint64_t contentId = 0);
