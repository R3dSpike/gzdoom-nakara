...
public:
	...
	VkTextureImage SceneFocusInfo;
	VkTextureImage SceneCloak;
	...
	VkFormat SceneFocusInfoFormat = VK_FORMAT_R8G8B8A8_UNORM;
	VkFormat SceneCloakFormat = VK_FORMAT_R8_UNORM;
...
private:
	...
	void CreateSceneFocusInfo(int width, int height, VkSampleCountFlagBits samples);
	void CreateSceneCloak(int width, int height, VkSampleCountFlagBits samples);
