...
static void ShaderSetFocusTintStrength(double value)
{
	if (value < 0.0) value = 0.0;
	if (value > 1.0) value = 1.0;
	nk_focus_tint_strength_runtime = (float)value;
}

DEFINE_ACTION_FUNCTION_NATIVE(_PPShader, SetFocusTintStrength, ShaderSetFocusTintStrength)
{
	PARAM_PROLOGUE;
	PARAM_FLOAT(value);
	ShaderSetFocusTintStrength(value);
	return 0;
}
