...
enum class PPTextureType { CurrentPipelineTexture, NextPipelineTexture, PPTexture, SceneColor, SceneFog, SceneNormal, SceneFocusInfo, SceneCloak, SceneDepth, SwapChain, ShadowMap };
...
public:
	...
	void SetInputSceneFocusInfo(int index, PPFilterMode filter = PPFilterMode::Nearest, PPWrapMode wrap = PPWrapMode::Clamp)
	{
		SetInputSpecialType(index, PPTextureType::SceneFocusInfo, filter, wrap);
	}

	void SetInputSceneCloak(int index, PPFilterMode filter = PPFilterMode::Nearest, PPWrapMode wrap = PPWrapMode::Clamp)
	{
		SetInputSpecialType(index, PPTextureType::SceneCloak, filter, wrap);
	}
...
struct CloakUniforms
{
	...
	static std::vector<UniformFieldDesc> Desc()
	{
		return
		{
			{ "Distortion", UniformType::Float, offsetof(CloakUniforms, Distortion) },
			{ "Shimmer", UniformType::Float, offsetof(CloakUniforms, Shimmer) },
			{ "Time", UniformType::Float, offsetof(CloakUniforms, Time) },
			{ "EdgeRefraction", UniformType::Float, offsetof(CloakUniforms, EdgeRefraction) },
			{ "Darkening", UniformType::Float, offsetof(CloakUniforms, Darkening) },
		};
	}
};

struct AmbientLightExtractUniforms
{
	float Darken;
	...
	static std::vector<UniformFieldDesc> Desc()
	{
		return
		{
			{ "Darken", UniformType::Float, offsetof(AmbientLightExtractUniforms, Darken) }
		};
	}
};
...
struct AmbientLightUniforms
{
	...
	static std::vector<UniformFieldDesc> Desc()
	{
		return
		{
			{ "Strength", UniformType::Float, offsetof(AmbientLightUniforms, Strength) },
			{ "Mix", UniformType::Float, offsetof(AmbientLightUniforms, Mix) },
			{ "Saturation", UniformType::Float, offsetof(AmbientLightUniforms, Saturation) },
			{ "SkyGuard", UniformType::Float, offsetof(AmbientLightUniforms, SkyGuard) },
			{ "Scale", UniformType::Vec2, offsetof(AmbientLightUniforms, Scale) },
			{ "Offset", UniformType::Vec2, offsetof(AmbientLightUniforms, Offset) }
		};
	}
};
...
struct DepthOfFieldUniforms
{
	...
	float RelativeRange;
	float Curve;
	float AutoFocusSampleRadius;
	float UseSmoothedFocus;
	float FocusSource;
	float MinFocusWidth;
	float MaxAmount;
	float AlphaProtect;
	...
	float FarFadeEnd;
	float DepthSoften;
	float DepthSoftenRadius;
	float DepthSoftenTolerance;
	float Padding0;
	FVector2 Scale;
	FVector2 Offset;
	...
	static std::vector<UniformFieldDesc> Desc()
	{
		return
		{
			{ "LinearizeDepthA", UniformType::Float, offsetof(DepthOfFieldUniforms, LinearizeDepthA) },
			{ "LinearizeDepthB", UniformType::Float, offsetof(DepthOfFieldUniforms, LinearizeDepthB) },
			{ "FocusDistance", UniformType::Float, offsetof(DepthOfFieldUniforms, FocusDistance) },
			{ "FocusRange", UniformType::Float, offsetof(DepthOfFieldUniforms, FocusRange) },
			{ "Strength", UniformType::Float, offsetof(DepthOfFieldUniforms, Strength) },
			{ "AutoFocus", UniformType::Float, offsetof(DepthOfFieldUniforms, AutoFocus) },
			{ "AutoFocusMin", UniformType::Float, offsetof(DepthOfFieldUniforms, AutoFocusMin) },
			{ "AutoFocusMax", UniformType::Float, offsetof(DepthOfFieldUniforms, AutoFocusMax) },
			{ "AutoFocusNear", UniformType::Float, offsetof(DepthOfFieldUniforms, AutoFocusNear) },
			{ "DebugMode", UniformType::Float, offsetof(DepthOfFieldUniforms, DebugMode) },
			{ "CenterMask", UniformType::Float, offsetof(DepthOfFieldUniforms, CenterMask) },
			{ "CenterRadius", UniformType::Float, offsetof(DepthOfFieldUniforms, CenterRadius) },
			{ "CenterFeather", UniformType::Float, offsetof(DepthOfFieldUniforms, CenterFeather) },
			{ "BokehEnable", UniformType::Float, offsetof(DepthOfFieldUniforms, BokehEnable) },
			{ "BokehRadius", UniformType::Float, offsetof(DepthOfFieldUniforms, BokehRadius) },
			{ "BokehMix", UniformType::Float, offsetof(DepthOfFieldUniforms, BokehMix) },
			{ "RelativeFocus", UniformType::Float, offsetof(DepthOfFieldUniforms, RelativeFocus) },
			{ "RelativeRange", UniformType::Float, offsetof(DepthOfFieldUniforms, RelativeRange) },
			{ "Curve", UniformType::Float, offsetof(DepthOfFieldUniforms, Curve) },
			{ "AutoFocusSampleRadius", UniformType::Float, offsetof(DepthOfFieldUniforms, AutoFocusSampleRadius) },
			{ "UseSmoothedFocus", UniformType::Float, offsetof(DepthOfFieldUniforms, UseSmoothedFocus) },
			{ "FocusSource", UniformType::Float, offsetof(DepthOfFieldUniforms, FocusSource) },
			{ "MinFocusWidth", UniformType::Float, offsetof(DepthOfFieldUniforms, MinFocusWidth) },
			{ "MaxAmount", UniformType::Float, offsetof(DepthOfFieldUniforms, MaxAmount) },
			{ "AlphaProtect", UniformType::Float, offsetof(DepthOfFieldUniforms, AlphaProtect) },
			{ "NearStrength", UniformType::Float, offsetof(DepthOfFieldUniforms, NearStrength) },
			{ "FarStrength", UniformType::Float, offsetof(DepthOfFieldUniforms, FarStrength) },
			{ "NearRangeMul", UniformType::Float, offsetof(DepthOfFieldUniforms, NearRangeMul) },
			{ "FarRangeMul", UniformType::Float, offsetof(DepthOfFieldUniforms, FarRangeMul) },
			{ "SoftMix", UniformType::Float, offsetof(DepthOfFieldUniforms, SoftMix) },
			{ "FocusDeadzone", UniformType::Float, offsetof(DepthOfFieldUniforms, FocusDeadzone) },
			{ "BlurGamma", UniformType::Float, offsetof(DepthOfFieldUniforms, BlurGamma) },
			{ "FocusWidthMax", UniformType::Float, offsetof(DepthOfFieldUniforms, FocusWidthMax) },
			{ "FarFadeStart", UniformType::Float, offsetof(DepthOfFieldUniforms, FarFadeStart) },
			{ "FarFadeEnd", UniformType::Float, offsetof(DepthOfFieldUniforms, FarFadeEnd) },
			{ "DepthSoften", UniformType::Float, offsetof(DepthOfFieldUniforms, DepthSoften) },
			{ "DepthSoftenRadius", UniformType::Float, offsetof(DepthOfFieldUniforms, DepthSoftenRadius) },
			{ "DepthSoftenTolerance", UniformType::Float, offsetof(DepthOfFieldUniforms, DepthSoftenTolerance) },
			{ "Scale", UniformType::Vec2, offsetof(DepthOfFieldUniforms, Scale) },
			{ "Offset", UniformType::Vec2, offsetof(DepthOfFieldUniforms, Offset) }
		};
	}
};


struct DepthOfFieldFocusUniforms
{
	float LinearizeDepthA;
	float LinearizeDepthB;
	float AutoFocusMin;
	...
	static std::vector<UniformFieldDesc> Desc()
	{
		return
		{
			{ "LinearizeDepthA", UniformType::Float, offsetof(DepthOfFieldFocusUniforms, LinearizeDepthA) },
			{ "LinearizeDepthB", UniformType::Float, offsetof(DepthOfFieldFocusUniforms, LinearizeDepthB) },
			{ "AutoFocusMin", UniformType::Float, offsetof(DepthOfFieldFocusUniforms, AutoFocusMin) },
			{ "AutoFocusMax", UniformType::Float, offsetof(DepthOfFieldFocusUniforms, AutoFocusMax) },
			{ "AutoFocusSampleRadius", UniformType::Float, offsetof(DepthOfFieldFocusUniforms, AutoFocusSampleRadius) },
			{ "FocusSmoothing", UniformType::Float, offsetof(DepthOfFieldFocusUniforms, FocusSmoothing) },
			{ "HasHistory", UniformType::Float, offsetof(DepthOfFieldFocusUniforms, HasHistory) },
			{ "Scale", UniformType::Vec2, offsetof(DepthOfFieldFocusUniforms, Scale) },
			{ "Offset", UniformType::Vec2, offsetof(DepthOfFieldFocusUniforms, Offset) }
		};
	}
};
...
struct MatrixMotionBlurUniforms
{
	VSMatrix InvCurrentViewProjection;
	VSMatrix PreviousViewProjection;
	float Strength;
	float Samples;
	float VelocityScale;
	float MinVelocity;
	...
	static std::vector<UniformFieldDesc> Desc()
	{
		return
		{
			{ "InvCurrentViewProjection", UniformType::Mat4, offsetof(MatrixMotionBlurUniforms, InvCurrentViewProjection) },
			{ "PreviousViewProjection", UniformType::Mat4, offsetof(MatrixMotionBlurUniforms, PreviousViewProjection) },
			{ "Strength", UniformType::Float, offsetof(MatrixMotionBlurUniforms, Strength) },
			{ "Samples", UniformType::Float, offsetof(MatrixMotionBlurUniforms, Samples) },
			{ "VelocityScale", UniformType::Float, offsetof(MatrixMotionBlurUniforms, VelocityScale) },
			{ "MinVelocity", UniformType::Float, offsetof(MatrixMotionBlurUniforms, MinVelocity) },
			{ "MaxRadius", UniformType::Float, offsetof(MatrixMotionBlurUniforms, MaxRadius) },
			{ "DepthCutoff", UniformType::Float, offsetof(MatrixMotionBlurUniforms, DepthCutoff) },
			{ "CenterFade", UniformType::Float, offsetof(MatrixMotionBlurUniforms, CenterFade) },
			{ "Padding0", UniformType::Float, offsetof(MatrixMotionBlurUniforms, Padding0) },
			{ "Scale", UniformType::Vec2, offsetof(MatrixMotionBlurUniforms, Scale) },
			{ "Offset", UniformType::Vec2, offsetof(MatrixMotionBlurUniforms, Offset) }
		};
	}
};
...
{
public:
	void RenderCloak(PPRenderState *renderstate, int sceneWidth, int sceneHeight);
	...
	void RenderAmbientLight(PPRenderState *renderstate, int sceneWidth, int sceneHeight);
	void RenderDepthOfField(PPRenderState *renderstate, int sceneWidth, int sceneHeight);
	void RenderMotionBlur(PPRenderState *renderstate, int sceneWidth, int sceneHeight, bool matrixHistoryValid, const VSMatrix &invCurrentViewProjection, const VSMatrix &previousViewProjection);
...
private:
	...
	PPViewport dofSceneViewport;
	PPViewport dofFocusViewport;
	PPTexture dofSceneTexture;
	PPTexture dofFocusTextureA;
	PPTexture dofFocusTextureB;
	bool dofFocusUseA = true;
	bool dofFocusValid = false;
	int lastWidth = 0;
	int lastHeight = 0;

	PPShader CloakCombine = { "shaders/pp/nakara_cloak.fp", "", CloakUniforms::Desc() };
	PPShader BloomCombine = { "shaders/pp/bloomcombine.fp", "", {} };
	PPShader BloomExtract = { "shaders/pp/bloomextract.fp", "", ExtractUniforms::Desc() };
	PPShader DepthOfFieldSceneCopy = { "shaders/pp/nakara_dof_scene_copy.fp", "", ExtractUniforms::Desc() };
	PPShader AmbientLightExtract = { "shaders/pp/nakara_ambient_light_extract.fp", "", AmbientLightExtractUniforms::Desc() };
	PPShader AmbientLightCombine = { "shaders/pp/nakara_ambient_light_combine.fp", "", AmbientLightUniforms::Desc() };
	PPShader AmbientLightCombineMS = { "shaders/pp/nakara_ambient_light_combine.fp", "#define MULTISAMPLE\n", AmbientLightUniforms::Desc() };
	PPShader DepthOfFieldFocusUpdate = { "shaders/pp/nakara_dof_focus_update.fp", "", DepthOfFieldFocusUniforms::Desc() };
	PPShader DepthOfFieldFocusUpdateMS = { "shaders/pp/nakara_dof_focus_update.fp", "#define MULTISAMPLE\n", DepthOfFieldFocusUniforms::Desc() };
	PPShader DepthOfFieldCombine = { "shaders/pp/nakara_dof_combine.fp", "", DepthOfFieldUniforms::Desc() };
	PPShader DepthOfFieldCombineMS = { "shaders/pp/nakara_dof_combine.fp", "#define MULTISAMPLE\n", DepthOfFieldUniforms::Desc() };
	PPShader MatrixMotionBlurCombine = { "shaders/pp/nakara_motion_blur_matrix.fp", "", MatrixMotionBlurUniforms::Desc() };
...
// [Nakara] Built-in horizontal aspect correction.
// This replaces the external Achthon overlay shader for the aspect-only path.
struct AspectCorrectionUniforms
{
	...
	static std::vector<UniformFieldDesc> Desc()
	{
		return
		{
			{ "HorizontalScale", UniformType::Float, offsetof(AspectCorrectionUniforms, HorizontalScale) },
			{ "Smoothing", UniformType::Float, offsetof(AspectCorrectionUniforms, Smoothing) },
			{ "Padding0", UniformType::Float, offsetof(AspectCorrectionUniforms, Padding0) },
			{ "Padding1", UniformType::Float, offsetof(AspectCorrectionUniforms, Padding1) }
		};
	}
};

class PPAspectCorrection
{
public:
	void Render(PPRenderState *renderstate);

private:
	PPShader AspectCorrection = { "shaders/pp/nakara_aspect_correction.fp", "", AspectCorrectionUniforms::Desc() };
};
...
public:
	PPBloom bloom;
	PPLensDistort lens;
	PPAspectCorrection aspectCorrection;
	PPFXAA fxaa;
	...
	float DofTraceFocusDistance = 768.0f;
	bool DofTraceFocusValid = false;
	bool DofTraceFocusHistoryValid = false;

	VSMatrix MotionCurrentViewProjection = VSMatrix(1);
	VSMatrix MotionPreviousViewProjection = VSMatrix(1);
	VSMatrix MotionInvCurrentViewProjection = VSMatrix(1);
	bool MotionCurrentMatrixValid = false;
	bool MotionHistoryValid = false;
	bool MotionProjectionValid = false;
	float MotionLastProjectionX = 0.0f;
	float MotionLastProjectionY = 0.0f;
	int MotionLastSceneWidth = -1;
	int MotionLastSceneHeight = -1;
	int MotionLastMSAA = -1;
	int MotionSkipFrames = 0;
	float MotionCurrentCameraX = 0.0f;
	float MotionCurrentCameraY = 0.0f;
	float MotionCurrentCameraZ = 0.0f;
	float MotionPreviousCameraX = 0.0f;
	float MotionPreviousCameraY = 0.0f;
	float MotionPreviousCameraZ = 0.0f;
	bool MotionCurrentCameraValid = false;
	bool MotionPreviousCameraValid = false;

	void SetTonemapMode(ETonemapMode tm) { tonemap.SetTonemapMode(tm); }
	void SetDepthOfFieldTraceFocus(bool valid, float distance);
	void ResetDepthOfFieldTraceFocus();
	void SetMainViewMatrices(const VSMatrix &viewMatrix, const VSMatrix &projectionMatrix);
	void InvalidateMotionBlurHistory(int skipFrames = 2);
	void AdvanceMotionBlurHistory();
	void ValidateMotionBlurHistoryForScene(int sceneWidth, int sceneHeight);
