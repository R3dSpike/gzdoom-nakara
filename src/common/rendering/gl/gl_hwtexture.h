...
private:
	...
	FTexture* mipChainSourceTex = nullptr;
	int mipChainTranslation = 0;
	int mipChainFlags = 0;
	uint64_t mipChainContentId = 0;
...
public:
	...
	void SetMipChainCacheContext(FTexture* sourceTex, int translation, int flags, uint64_t contentId)
	{
		mipChainSourceTex = sourceTex;
		mipChainTranslation = translation;
		mipChainFlags = flags;
		mipChainContentId = contentId;
	}

	void ClearMipChainCacheContext()
	{
		mipChainSourceTex = nullptr;
		mipChainTranslation = 0;
		mipChainFlags = 0;
		mipChainContentId = 0;
	}
