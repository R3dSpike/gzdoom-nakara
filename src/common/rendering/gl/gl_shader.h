...
class FShader
{
	...
	FBufferedUniform1f muFocusHighlight;
	FBufferedUniform4f muFocusTintColor;
	FBufferedUniform1f muFocusTintAmount;
	FBufferedUniform1i muFocusTintStyle;
	FBufferedUniform4f muFocusOutlineColor;
	FBufferedUniform1f muFocusOutlineThickness;
	FBufferedUniform4f muNkVisThruWallTint;
	FBufferedUniform1f muNkVisThruWallSpriteAlpha;
	FBufferedUniform1f muNkVisThruWallOutlineThickness;
	FBufferedUniform1f muNkVisThruWallOutlineAlpha;
	FBufferedUniform1f muNkCloakAmount;
