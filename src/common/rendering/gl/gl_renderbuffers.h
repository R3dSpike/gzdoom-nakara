...
public:
	...
	void BindSceneFocusInfoTexture(int index);
	void BindSceneCloakTexture(int index);
...
private:
	...
	PPGLFrameBuffer CreateFrameBuffer(const char *name, PPGLTexture colorbuffer0, PPGLTexture colorbuffer1, PPGLTexture colorbuffer2, PPGLTexture colorbuffer3, PPGLTexture colorbuffer4, PPGLTexture depthstencil, bool multisample);
	...
	PPGLTexture mSceneFocusInfoTex;
	PPGLTexture mSceneCloakTex;
	...
	PPGLRenderBuffer mSceneFocusInfoBuf;
	PPGLRenderBuffer mSceneCloakBuf;
