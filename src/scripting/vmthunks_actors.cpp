...
DEFINE_ACTION_FUNCTION_NATIVE(AActor, PrecacheActorClass, P_PrecacheActorClass)
{
	PARAM_PROLOGUE;
	PARAM_CLASS(cls, AActor);

	P_PrecacheActorClass(cls);
	return 0;
}
...
DEFINE_FIELD(AActor, FocusTintColor)
DEFINE_FIELD(AActor, FocusTintAmount)
DEFINE_FIELD(AActor, FocusTintStyle)
DEFINE_FIELD(AActor, bFocusTintColorSet)
DEFINE_FIELD(AActor, FocusTintOutlineColor)
DEFINE_FIELD(AActor, bFocusTintOutlineColorSet)
DEFINE_FIELD(AActor, FocusTintOutlineThickness)
DEFINE_FIELD(AActor, VisThruWallColor)
DEFINE_FIELD(AActor, bVisThruWallColorSet)
DEFINE_FIELD(AActor, VisThruWallAlpha)
DEFINE_FIELD(AActor, bVisThruWallAlphaSet)
DEFINE_FIELD(AActor, VisThruWallSpriteAlpha)
DEFINE_FIELD(AActor, bVisThruWallSpriteAlphaSet)
DEFINE_FIELD(AActor, VisThruWallOutlineThickness)
DEFINE_FIELD(AActor, VisThruWallOutlineAlpha)
DEFINE_FIELD(AActor, bVisThruWallOutlineAlphaSet)
DEFINE_FIELD(AActor, VisThruWallMaxDistance)
DEFINE_FIELD(AActor, VisThruWallFadeDistance)
DEFINE_FIELD(AActor, VisThruWallFadeInTics)
DEFINE_FIELD(AActor, VisThruWallFadeOutTics)
DEFINE_FIELD(AActor, VisThruWallMask)
