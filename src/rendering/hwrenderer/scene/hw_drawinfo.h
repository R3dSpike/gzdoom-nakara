...
struct HWDrawInfo
{
	...
	// [Nakara] Separate +VISTHRUWALL candidate list.
	// This is intentionally independent from FocusHighlight and the focus mask pipeline.
	HWDrawList VisThruWallDrawList;
	HWDrawList VisThruWallOccluderDrawList;
	HWDrawList VisThruWallSpriteMaskDrawList;
	bool VisThruWallCollectPass = false;
	bool VisThruWallOccluderCollectPass = false;
	bool VisThruWallSpriteMaskCollectPass = false;
	bool VisThruWallRenderPass = false;
	int VisThruWallEmptyScanCooldown = 0;
	int VisThruWallSpriteMaskUpdateCountdown = 0;
	double VisThruWallGlobalFade = 0.0;
	int VisThruWallLastGlobalFadeTic = 0;

	// [Nakara] Debug counters for VisThruWall performance tuning.
	int VisThruWallDebugLastPrintTic = -1;
	int VisThruWallDebugTargetsSeen = 0;
	int VisThruWallDebugTargetsAccepted = 0;
	int VisThruWallDebugTargetsFadeSkipped = 0;
	int VisThruWallDebugOccludersSeen = 0;
	int VisThruWallDebugOccludersAccepted = 0;
	int VisThruWallDebugSmartTargets = 0;
	int VisThruWallDebugSpriteMaskSeen = 0;
	int VisThruWallDebugSpriteMaskAccepted = 0;
	int VisThruWallDebugSpriteMaskSmartRejected = 0;
	int VisThruWallDebugSpriteMaskFlagSkipped = 0;
	int VisThruWallDebugSpriteMaskViewSkipped = 0;
	bool VisThruWallDebugSpriteMaskUpdateSkipped = false;
	bool VisThruWallDebugSkippedByEmptyCooldown = false;
	int vpIndex;
...
public:
	...
	void BuildVisThruWallDrawList();
	void BuildVisThruWallOccluderDrawList();
	void BuildVisThruWallSpriteMaskDrawList();
